...
class NilaiStandar5Controller extends Controller
{
  public function index($idprodi)
  {
    ...
    $nilai_kprodi=Standar5::select('kode','kategori')->where('id_prodi',$idprodi)->get();
    $nilai_auditor=Standar5Auditor::select('kode','kategori')->where([['id_prodi', '=',$idprodi], ['auditor_id', '=',session("auditor_id")]])->get();
