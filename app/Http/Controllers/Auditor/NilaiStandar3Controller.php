...
class NilaiStandar3Controller extends Controller
{
  public function index($idprodi)
  {
    ...
    $nilai_kprodi=Standar3::select('kode','kategori')->where('id_prodi',$idprodi)->get();
    $nilai_auditor=Standar3Auditor::select('kode','kategori')->where([['id_prodi', '=',$idprodi], ['auditor_id', '=',session("auditor_id")]])->get();
