...
class Standar6Controller extends Controller
{
    public function index()
    {
        ...
        $prodi = $this->getProdi();
        return view('standar6.index', compact('standar', 'data', 'dataCheck', 'prodi'));
    }
     public function save(Request $request)
     {
      ...
      $oldStandar6 = Standar6::where('id_prodi', '=', session('id_prodi'))->whereYear("created_at", '=', date("Y"))->first();
      if($oldStandar6){
        //jika sudah maka ...
        ...
        $standar6->kode = '6.2.1';
        $standar6->id_prodi = session('id_prodi');
        $standar6->kategori = $kategori6_2_1;
        $standar6->data = $data6_2_1;
        $standar6->skor = $skor6_2_1;
        $standar6->save();
