                        ...
                        <div class="col-md-12 komponen">
                           ...
                           <div class="dropdown pull-right">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right"> 
                                      <li><a href="#" data-toggle="modal" data-target="#upload_file"  data-catatan="{{ $catatan_auditor["2.1"] or " " }}" data-kode="2.1">Catatan Auditor</a></li>
                                </ul>
                              </div>
                        </div>
                        <div class="col-md-12">
                    ...
                    <li class="row">
                        <div class="col-md-12 komponen">
                           ...
                           <div class="dropdown pull-right">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right"> 
                                      <li><a href="#" data-toggle="modal" data-target="#upload_file"  data-catatan="{{ $catatan_auditor["2.2"] or " " }}" data-kode="2.2">Catatan Auditor</a></li>
                                </ul>
                              </div>
                        </div>
                        <div class="col-md-12">
                    ...
                    <li class="row">
                        <div class="col-md-12 komponen">
                           ...
                           <div class="dropdown pull-right">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right"> 
                                      <li><a href="#" data-toggle="modal" data-target="#upload_file"  data-catatan="{{ $catatan_auditor["2.6"] or " " }}" data-kode="2.6">Catatan Auditor</a></li>
                                </ul>
                              </div>
